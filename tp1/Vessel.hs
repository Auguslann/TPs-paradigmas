...
newV cantStack capacity ruta  | cantStack < 0 || capacity < 0 = error "La cantidad de bahias y la capacidad de las mismas no pueden ser negativas"
                              | otherwise = (Ves (replicate cantStack (newS capacity)) ruta)
